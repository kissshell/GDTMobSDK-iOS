...
class NativeExpressAdViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,GDTNativeExpressAdDelegete {
    ...
    let ABOVEPH_BLOWTEXT_STR = "3062839875997662"

    let ABOVETEXT_BLOW_PH_STR = "3062839875997662"

    let LEFTPH_RIHGTTEXT_STR = "3062839875997662"

    let LEFTTEXT_RIGHTPH_STR = "3062839875997662"

    let TWOPH_AND_TEXT_STR = "3062839875997662"

    let WIDTHPHOTO_STR = "8032831922830559"

    let HEIGHTPHOTO_STR = "8032831922830559"

    let THREE_SMALLPH_STR = "8032831922830559"

    let ABOVETEXT_SURFACE_BLOWPH_STR = "8032831922830559"

    let ABOVEPH_BLOWTEXT_SURFACE_STR = "8032831922830559"

    let TEXTSURFACE_ONEPHOTO_STR = "8032831922830559"

    let HEIGHTERPHOTO_STR = "8032831922830559"
